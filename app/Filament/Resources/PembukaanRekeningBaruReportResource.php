...
use App\Models\PembukaanRekeningBaruReport;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\PembukaanRekeningBaruReportResource\Pages;
use App\Filament\Resources\PembukaanRekeningBaruReportResource\RelationManagers;

class PembukaanRekeningBaruReportResource extends Resource
{
    protected static ?string $model = PembukaanRekeningBaruReport::class;

    protected static ?string $navigationIcon = 'heroicon-o-document-arrow-down';
    protected static ?string $navigationGroup = 'Report';
    protected static ?string $navigationLabel = 'Report Saving Account';
    ...
    {
        return [
            'index' => Pages\ListPembukaanRekeningBaruReports::route('/'),
            // 'create' => Pages\CreatePembukaanRekeningBaruReport::route('/create'),
            'view' => Pages\ViewPembukaanRekeningBaruReport::route('/{record}'),
            'edit' => Pages\EditPembukaanRekeningBaruReport::route('/{record}/edit'),
        ];
    }
