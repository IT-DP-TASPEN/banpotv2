...
class PermintaanCheckingReportResource extends Resource
{
    protected static ?string $model = PermintaanCheckingReport::class;

    protected static ?string $navigationIcon = 'heroicon-o-document-arrow-down';
    protected static ?string $navigationGroup = 'Report';
    protected static ?string $navigationLabel = 'Report Checking';
    ...
    {
        return [
            'index' => Pages\ListPermintaanCheckingReports::route('/'),
            // 'create' => Pages\CreatePermintaanCheckingReport::route('/create'),
            'view' => Pages\ViewPermintaanCheckingReport::route('/{record}'),
            'edit' => Pages\EditPermintaanCheckingReport::route('/{record}/edit'),
        ];
    }
