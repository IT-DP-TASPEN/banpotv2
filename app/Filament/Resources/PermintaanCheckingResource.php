...
use App\Filament\Resources\PermintaanCheckingResource\Pages;
use App\Filament\Resources\PermintaanCheckingResource\RelationManagers;
...
class PermintaanCheckingResource extends Resource
{
    protected static ?string $model = PermintaanChecking::class;

    protected static ?string $navigationIcon = 'heroicon-o-document-arrow-up';
    protected static ?string $navigationGroup = 'Request Flagging and Mutasi';
    protected static ?string $navigationLabel = 'Request Checking';
    ...
    {
        return [
            'index' => Pages\ListPermintaanCheckings::route('/'),
            'create' => Pages\CreatePermintaanChecking::route('/create'),
            'view' => Pages\ViewPermintaanChecking::route('/{record}'),
            'edit' => Pages\EditPermintaanChecking::route('/{record}/edit'),
        ];
    }
