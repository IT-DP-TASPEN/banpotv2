...
use App\Models\BanpotMasterNeedProsesMitra;
use Filament\Tables\Columns\Summarizers\Sum;
use Filament\Tables\Columns\Summarizers\Summarizer;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\BanpotMasterNeedProsesMitraResource\Pages;
use App\Filament\Resources\BanpotMasterNeedProsesMitraResource\RelationManagers;

class BanpotMasterNeedProsesMitraResource extends Resource
{
    protected static ?string $model = BanpotMasterNeedProsesMitra::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';
    protected static ?string $navigationGroup = 'Banpot';
    protected static ?string $navigationLabel = 'Banpot Need Check Mitra';
    protected static ?string $navigationBadge = 'Need Check';
    ...
    {
        return [
            'index' => Pages\ListBanpotMasterNeedProsesMitras::route('/'),
            'create' => Pages\CreateBanpotMasterNeedProsesMitra::route('/create'),
            'view' => Pages\ViewBanpotMasterNeedProsesMitra::route('/{record}'),
            'edit' => Pages\EditBanpotMasterNeedProsesMitra::route('/{record}/edit'),
        ];
    }
