...
use App\Models\PermintaanEstimasiReport;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\PermintaanEstimasiReportResource\Pages;
use App\Filament\Resources\PermintaanEstimasiReportResource\RelationManagers;

class PermintaanEstimasiReportResource extends Resource
{
    protected static ?string $model = PermintaanEstimasiReport::class;

    protected static ?string $navigationIcon = 'heroicon-o-document-arrow-down';
    protected static ?string $navigationGroup = 'Report';
    protected static ?string $navigationLabel = 'Report Estimasi';
    ...
    {
        return [
            'index' => Pages\ListPermintaanEstimasiReports::route('/'),
            // 'create' => Pages\CreatePermintaanEstimasiReport::route('/create'),
            'view' => Pages\ViewPermintaanEstimasiReport::route('/{record}'),
            'edit' => Pages\EditPermintaanEstimasiReport::route('/{record}/edit'),
        ];
    }
