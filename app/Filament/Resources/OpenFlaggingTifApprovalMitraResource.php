...
use App\Models\OpenFlaggingTifApprovalMitra;
use Filament\Tables\Columns\Summarizers\Summarizer;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\OpenFlaggingTifApprovalMitraResource\Pages;
use App\Filament\Resources\OpenFlaggingTifApprovalMitraResource\RelationManagers;

class OpenFlaggingTifApprovalMitraResource extends Resource
{
    protected static ?string $model = OpenFlaggingTifApprovalMitra::class;

    protected static ?string $navigationIcon = 'heroicon-o-document-check';
    protected static ?string $navigationGroup = 'Approval Flagging and Mutasi';
    protected static ?string $navigationLabel = 'Approval Open Flagging TIF';
    ...
    {
        return [
            'index' => Pages\ListOpenFlaggingTifApprovalMitras::route('/'),
            // 'create' => Pages\CreateOpenFlaggingTifApprovalMitra::route('/create'),
            'view' => Pages\ViewOpenFlaggingTifApprovalMitra::route('/{record}'),
            'edit' => Pages\EditOpenFlaggingTifApprovalMitra::route('/{record}/edit'),
        ];
    }
