...
use App\Models\BanpotMasterReport;
use App\Models\IdentitasMitraMaster;
use Illuminate\Database\Eloquent\Builder;
use Filament\Tables\Columns\Summarizers\Sum;
use Filament\Tables\Columns\Summarizers\Summarizer;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\BanpotMasterReportResource\Pages;
use App\Filament\Resources\BanpotMasterReportResource\RelationManagers;

class BanpotMasterReportResource extends Resource
{
    protected static ?string $model = BanpotMasterReport::class;

    protected static ?string $navigationIcon = 'heroicon-o-document-arrow-down';
    protected static ?string $navigationGroup = 'Report';
    protected static ?string $navigationLabel = 'Report Bantuan Potong';
    ...
    {
        return [
            'index' => Pages\ListBanpotMasterReports::route('/'),
            // 'create' => Pages\CreateBanpotMasterReport::route('/create'),
            'view' => Pages\ViewBanpotMasterReport::route('/{record}'),
            'edit' => Pages\EditBanpotMasterReport::route('/{record}/edit'),
        ];
    }
