...
use App\Models\PermintaanEstimasiApproval;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\PermintaanEstimasiApprovalResource\Pages;
use App\Filament\Resources\PermintaanEstimasiApprovalResource\RelationManagers;

class PermintaanEstimasiApprovalResource extends Resource
{
    protected static ?string $model = PermintaanEstimasiApproval::class;

    protected static ?string $navigationIcon = 'heroicon-o-document-check';
    protected static ?string $navigationGroup = 'Approval Flagging and Mutasi';
    protected static ?string $navigationLabel = 'Approval Estimasi';
    ...
    {
        return [
            'index' => Pages\ListPermintaanEstimasiApprovals::route('/'),
            // 'create' => Pages\CreatePermintaanEstimasiApproval::route('/create'),
            'view' => Pages\ViewPermintaanEstimasiApproval::route('/{record}'),
            'edit' => Pages\EditPermintaanEstimasiApproval::route('/{record}/edit'),
        ];
    }
