...
use App\Models\PermintaanCheckingApproval;
use Filament\Tables\Columns\Summarizers\Summarizer;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\PermintaanCheckingApprovalResource\Pages;
use App\Filament\Resources\PermintaanCheckingApprovalResource\RelationManagers;

class PermintaanCheckingApprovalResource extends Resource
{
    protected static ?string $model = PermintaanCheckingApproval::class;

    protected static ?string $navigationIcon = 'heroicon-o-document-check';
    protected static ?string $navigationGroup = 'Approval Flagging and Mutasi';
    protected static ?string $navigationLabel = 'Approval Checking';
    ...
    {
        return [
            'index' => Pages\ListPermintaanCheckingApprovals::route('/'),
            // 'create' => Pages\CreatePermintaanCheckingApproval::route('/create'),
            'view' => Pages\ViewPermintaanCheckingApproval::route('/{record}'),
            'edit' => Pages\EditPermintaanCheckingApproval::route('/{record}/edit'),
        ];
    }
