...
use App\Models\PermintaanMutasiTosApprovalMitra;
use Filament\Tables\Columns\Summarizers\Summarizer;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\PermintaanMutasiTosApprovalMitraResource\Pages;
use App\Filament\Resources\PermintaanMutasiTosApprovalMitraResource\RelationManagers;

class PermintaanMutasiTosApprovalMitraResource extends Resource
{
    protected static ?string $model = PermintaanMutasiTosApprovalMitra::class;

    protected static ?string $navigationIcon = 'heroicon-o-document-check';
    protected static ?string $navigationGroup = 'Approval Flagging and Mutasi';
    protected static ?string $navigationLabel = 'Approval Mutasi TOS';
    ...
    {
        return [
            'index' => Pages\ListPermintaanMutasiTosApprovalMitras::route('/'),
            // 'create' => Pages\CreatePermintaanMutasiTosApprovalMitra::route('/create'),
            'view' => Pages\ViewPermintaanMutasiTosApprovalMitra::route('/{record}'),
            'edit' => Pages\EditPermintaanMutasiTosApprovalMitra::route('/{record}/edit'),
        ];
    }
