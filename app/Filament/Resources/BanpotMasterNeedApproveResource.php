...
use App\Models\BanpotMasterNeedApprove;
use Illuminate\Database\Eloquent\Builder;
use Filament\Tables\Columns\Summarizers\Sum;
use Filament\Tables\Columns\Summarizers\Summarizer;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\BanpotMasterNeedApproveResource\Pages;
use App\Filament\Resources\BanpotMasterNeedApproveResource\RelationManagers;

class BanpotMasterNeedApproveResource extends Resource
{
    protected static ?string $model = BanpotMasterNeedApprove::class;
