...
{
    /**
     * Handle the BanpotMaster "created" event.
     */
    public function created(BanpotMaster $banpotMaster): void {}

    /**
     * Handle the BanpotMaster "updated" event.
     */
    public function updated(BanpotMaster $banpotMaster): void {}


    public function saved(BanpotMaster $record): void
    {
        if (
    ...
    /**
     * Handle the BanpotMaster "deleted" event.
     */
    public function deleted(BanpotMaster $banpotMaster): void
    {
        //
    }

    /**
     * Handle the BanpotMaster "restored" event.
     */
    public function restored(BanpotMaster $banpotMaster): void
    {
        //
    }

    /**
     * Handle the BanpotMaster "force deleted" event.
     */
    public function forceDeleted(BanpotMaster $banpotMaster): void
    {
        //
    }
}
